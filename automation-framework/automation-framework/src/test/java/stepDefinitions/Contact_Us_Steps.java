...
public class Contact_Us_Steps extends Base_PO {
    ...
    @Then("I should presented with a successful contact us submission message") // assertion use testng assertion
    public void i_should_presented_with_a_successful_contact_us_submission_message() {
